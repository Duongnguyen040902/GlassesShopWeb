...
var SimpleBar = function () {
    ...
    function A(e, t, i) {
        ...
        function x() {
            ...
            return void 0 === n && (n = setTimeout(b, t)),
                o
        }
        return t = E(t) || 0,
            m(i) && (h = !!i.leading,
    ...
    t && window.addEventListener("resize", (function () {
        M !== window.devicePixelRatio && (M = window.devicePixelRatio,
            W = null)
    }
    ));
    var C = function (e) {
            ...
            function e(t, i) {
                ...
                if (this.removePreventClickId = null,
                    ...
                    this.onScroll = function () {
                        var e = H(s.el);
                        s.scrollXTicking || (e.requestAnimationFrame(s.scrollX),
                            s.scrollXTicking = !0),
                            s.scrollYTicking || (e.requestAnimationFrame(s.scrollY),
                                s.scrollYTicking = !0),
                            s.isScrolling || (s.isScrolling = !0,
                    ...
                    this._onStopScrolling = function () {
                        q(s.el, s.classNames.scrolling),
                            s.options.autoHide && (s.hideScrollbar("x"),
                                s.hideScrollbar("y")),
                            s.isScrolling = !1
                    }
                    ,
                    this.onMouseEnter = function () {
                        s.isMouseEntering || (_(s.el, s.classNames.mouseEntered),
                            s.showScrollbar("x"),
                            s.showScrollbar("y"),
                            s.isMouseEntering = !0),
                            s.onMouseEntered()
                    ...
                    this.onPointerEvent = function (e) {
                        var t, i;
                        s.axis.x.track.el && s.axis.y.track.el && s.axis.x.scrollbar.el && s.axis.y.scrollbar.el && (s.axis.x.track.rect = s.axis.x.track.el.getBoundingClientRect(),
                            ...
                            (t || i) && (e.stopPropagation(),
                                "pointerdown" === e.type && "touch" !== e.pointerType && (t && (s.axis.x.scrollbar.rect = s.axis.x.scrollbar.el.getBoundingClientRect(),
                                    s.isWithinBounds(s.axis.x.scrollbar.rect) ? s.onDragStart(e, "x") : s.onTrackClick(e, "x")),
                                    i && (s.axis.y.scrollbar.rect = s.axis.y.scrollbar.el.getBoundingClientRect(),
                                        s.isWithinBounds(s.axis.y.scrollbar.rect) ? s.onDragStart(e, "y") : s.onTrackClick(e, "y")))))
                    }
                    ,
                ...
                this.onMouseMove = function (e, t, i) {
                    ...
                    if ("function" != typeof e)
                        throw new TypeError("Expected a function");
                    return m(i) && (s = "leading" in i ? !!i.leading : s,
            ...
            return e.getRtlHelpers = function () {
                ...
                e.prototype.initDOM = function () {
                    ...
                    this.wrapperEl = this.el.querySelector(P(this.classNames.wrapper)),
                        ...
                        this.options.autoHide || (_(this.axis.x.scrollbar.el, this.classNames.visible),
                ...
                e.prototype.getScrollbarSize = function (e) {
                    ...
                    if (void 0 === e && (e = "y"),
                        ...
                        return 0;
                    var s, r = this.contentEl[this.axis[e].scrollSizeAttr], l = null !== (i = null === (t = this.axis[e].track.el) || void 0 === t ? void 0 : t[this.axis[e].offsetSizeAttr]) && void 0 !== i ? i : 0, o = l / r;
                    return s = Math.max(~~(o * l), this.options.scrollbarMinSize),
                ...
                e.prototype.positionScrollbar = function (t) {
                    ...
                    if (this.axis[t].isOverflowing && this.contentWrapperEl && l.el && this.elStyles) {
                        ...
                        u = "x" === t && this.isRtl ? -u + (n - l.size) : u,
                            l.el.style.transform = "x" === t ? "translate3d(".concat(u, "px, 0, 0)") : "translate3d(0, ".concat(u, "px, 0)")
                    }
                }
                ,
                ...
                e.prototype.showScrollbar = function (e) {
                    void 0 === e && (e = "y"),
                        this.axis[e].isOverflowing && !this.axis[e].scrollbar.isVisible && (_(this.axis[e].scrollbar.el, this.classNames.visible),
                ...
                e.prototype.onMouseMoveForAxis = function (e) {
                    ...
                    t.track.el && t.scrollbar.el && (t.track.rect = t.track.el.getBoundingClientRect(),
                        ...
                        this.isWithinBounds(t.track.rect) ? (this.showScrollbar(e),
                            ...
                            this.isWithinBounds(t.scrollbar.rect) ? _(t.scrollbar.el, this.classNames.hover) : q(t.scrollbar.el, this.classNames.hover)) : (q(t.track.el, this.classNames.hover),
                ...
                e.prototype.onDragStart = function (e, t) {
                    ...
                    this.axis[t].dragOffset = o - ((null === (i = l.rect) || void 0 === i ? void 0 : i[this.axis[t].offsetAttr]) || 0),
                        ...
                        null === this.removePreventClickId ? (s.addEventListener("click", this.preventClick, !0),
                            s.addEventListener("dblclick", this.preventClick, !0)) : (r.clearTimeout(this.removePreventClickId),
                ...
                e.prototype.onTrackClick = function (e, t) {
                    ...
                    if (this.options.clickOnTrack && n.scrollbar.el && this.contentWrapperEl) {
                        ...
                        var c = null !== (s = null === (i = this.axis[t].scrollbar.rect) || void 0 === i ? void 0 : i[this.axis[t].offsetAttr]) && void 0 !== s ? s : 0
                            ...
                            , p = -1 === d ? u - h : u + h
                            , v = function () {
                                o.contentWrapperEl && (-1 === d ? u > p && (u -= 40,
                                    o.contentWrapperEl[o.axis[t].scrollOffsetAttr] = u,
                                    a.requestAnimationFrame(v)) : u < p && (u += 40,
                                        o.contentWrapperEl[o.axis[t].scrollOffsetAttr] = u,
        ...
        , $ = function (t) {
            ...
            return function (t, i) {
                ...
                i.prototype.initDOM = function () {
                    ...
                    if (!Array.prototype.filter.call(this.el.children, (function (e) {
                        ...
                        for (this.wrapperEl = document.createElement("div"),
                            ...
                            I(this.heightAutoObserverEl, this.classNames.heightAutoObserverEl); this.el.firstChild;)
                ...
                i.prototype.unMount = function () {
                    X.prototype.unMount.call(this),
                        i.instances.delete(this.el)
                }
                ,
                i.initHtmlApi = function () {
                    this.initDOMLoadedElements = this.initDOMLoadedElements.bind(this),
                        "undefined" != typeof MutationObserver && (this.globalObserver = new MutationObserver(i.handleMutations),
